...
class User < ApplicationRecord
  ...
  def friends
    friends_group = self.friendships.map{ |friendship| friendship.friend if friendship.confirmed }
    friends_group += self.inverse_friendships.map{ |friendship| friendship.user if friendship.confirmed }
